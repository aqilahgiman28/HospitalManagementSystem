...
//            SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd", Locale.UNICODE_LOCALE_EXTENSION);
//            SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");

            String d = request.getParameter("date").trim();
            String t = request.getParameter("time").trim();
            String st = request.getParameter("status").trim();
            String id = request.getParameter("id").trim();

            boolean statusInsert = false;

            Slot updateS = new Slot(st, d, t);
