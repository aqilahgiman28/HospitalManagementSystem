                ...
                <div class="container-xl px-4 mt-4">
                    ...
                    <div class="row justify-content-center align-items-center">
                        <div class="col-xl-8">
                            ...
                            <div class="card mb-4">
                                <div class="card-header">Update Doctor Details</div>
                                <div class="card-body">
                                    <form action="../updateDoctor" method="post">
                                        ...
                                        <div class="row gx-3 mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <label class="small mb-1" >Specialization</label>
                                                <input class="form-control" id="floatingInput" name="specialization" type="text" placeholder="description" value="<% out.println(rs.getString("specialization"));%>" />
                        ...
                        out.println("No doctor data found.");
                    }
                %>
