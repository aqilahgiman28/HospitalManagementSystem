...
<%
    ...
    if (rowAffected > 0) {
        ...
        response.sendRedirect("/HospitalManagementSystem-main/admin/medicine.jsp?status=deleted&rowAffected=" + rowAffected);

    }else{
        response.sendRedirect("/HospitalManagementSystem-main/admin/medicine.jsp?status=failed");
    }
