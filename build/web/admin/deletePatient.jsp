...
<%
    ...
    if (rowAffected > 0) {
        ...
        response.sendRedirect("/HospitalManagementSystem/admin/patient.jsp?status=deleted&rowAffected=" + rowAffected);

    }else{
        response.sendRedirect("/HospitalManagementSystem/admin/patient.jsp?status=failed");
    }
