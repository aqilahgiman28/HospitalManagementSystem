...
<%
    ...
    if (rowAffected > 0) {
        ...
        response.sendRedirect("/HospitalManagementSystem-main/admin/prescription.jsp?status=deleted&rowAffected=" + rowAffected);

    }else{
        response.sendRedirect("/HospitalManagementSystem-main/admin/prescription.jsp?status=failed");
    }
